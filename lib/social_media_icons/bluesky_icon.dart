...
class BlueskyIcon extends StatelessComponent {
  ...
  Iterable<Component> build(BuildContext context) sync* {
    yield SocialMediaIcon(data: _svgData, href: '#');
  }
}
